       ...
       <!-- Left Image-->
        <div class="span5">
          <ul class="thumbnails mainimage">
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="<?php if($logo == '') echo 'image/default.jpg'; else echo 'profiles/'.$logo; ?>">
                <img src="<?php if($logo == '') echo 'image/default.jpg'; else echo 'profiles/'.$logo; ?>" alt="" title="">
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="span7">
            ...
            <div class="span7">
              ...
              <div class="productprice">
                ...
                <div class="productpageprice">
                  <span class="spiral"></span><?php echo $telephone; ?></div>
              </div>
         ...
         <div class="productdesc">
                <ul class="nav nav-tabs" id="myTab">
                  ...
                  <li><a href="#specification">Company Adress</a>
                  </li>
                  <li><a href="#review">Bank</a>
                  </li>
                  <li><a href="#producttag">B-BBEE</a>
                  </li>
                </ul>
